...
sumagricb = agricb[['org_fert', 'chem_fert', 'pesticides', 'hhlabor', 'hired_labor', 'area_planted', 'seed_cost', 'trans_cost', 'total_value_p_sell', 'total2_value_p_sell', 'farm_capital']].describe()
#crop in production and planting coincide so we can eliminate one of them (in importing 2agsec4 do not import crop)

agricb[['org_fert', 'chem_fert', 'pesticides', 'hhlabor', 'hired_labor', 'area_planted', 'seed_cost', 'trans_cost', 'total_value_p_sell', 'total2_value_p_sell', 'farm_capital']] = remove_outliers(agricb[['org_fert', 'chem_fert', 'pesticides', 'hhlabor', 'hired_labor', 'area_planted', 'seed_cost', 'trans_cost', 'total_value_p_sell', 'total2_value_p_sell', 'farm_capital']], lq=0, hq=0.99)
sumagricb2 = agricb[['org_fert', 'chem_fert', 'pesticides', 'hhlabor', 'hired_labor', 'area_planted', 'seed_cost', 'trans_cost', 'total_value_p_sell', 'total2_value_p_sell', 'farm_capital']].describe()/dollars
